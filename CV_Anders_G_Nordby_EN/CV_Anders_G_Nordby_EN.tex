...
{
\textbf{Customer:} GEBHARDT Fördertechnik GmbH 

\textbf{Role:} Senior Developer

\textbf{Duration:} 3 months

\textbf{Technologies:} C\#, .NET Core, GitLab, YouTrack, Powershell.
...
\section{Languages} 
\begin{supertabular}{rl} 
	\tableentry{Professional}{Norwegian (native), English}{}
	\tableentry{Conversational}{German (B2), Bulgarian}{}
	\tableentry{Beginner}{Spanish, Catalan, Japanese}{}
\end{supertabular}
\end{paracol}
\end{document}
