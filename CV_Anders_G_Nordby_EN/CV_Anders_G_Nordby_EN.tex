...
\textbf{Customers:} ABB, Frank Resource Group.

\textbf{Technologies:} Azure DevOps, Akka.NET, TypeScript, React JS, C\#, Microsoft .NET Core 2.2, ASP.NET Core MVC, Keycloak, TFS, Git.
} 
...
\textbf{Technologies:} C\#, .Net, inRiver PIM, Apptus eSales, Episerver CMS, Episerver Commerce, IdentityServer, T-SQL, WebAPI, NServiceBus, Jira, Confluence, jMeter, BlazeMeter, Angular.js, Knockout.js.
} 
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{\textsc{08.1994 -- 07.1995}}{\textbf{Gran skole}, Substitute Teacher}{}
\end{supertabular}
