...
Anders is a project manager, systems architect and senior developer with customer focus and many years of experience in the industry. He has had the role of \textit{team leader} and \textit{scrum master} in several projects. 
...
\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
	...
	\colorbox{shade}{ % Create the coloured box
		\begin{supertabular}{p{0.05\linewidth}|p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
			\raisebox{-1pt}{\faHome} & Isarstraße 34, \\ % Address
			\raisebox{-1pt}{} & 83026 Rosenheim, GERMANY \\ % Address
...
\longformdescription{Development}{C\#, Akka.Net, GraphQL, NHibernate, Blazor, Gherkin, Specflow, Cypress, NUnit, Moq, DoxFx, Docker, Swagger, Kiuwan, PowerBI, log4net, Episerver, ASP.Net, T-SQL, PL/SQL, Javascript, JSON, NServiceBus, REST, WebAPI, XML, HTML, CSS, Powershell, \LaTeX.}

\longformdescription{Tools}{Jira, Confluence, TeamCity, Octopus Deploy, Git, TFS, SubVersion, NewRelic, jMeter, BlazeMeter, NuGet, Kiuwan.}
