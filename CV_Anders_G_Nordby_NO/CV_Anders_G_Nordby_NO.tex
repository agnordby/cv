...
\textbf{Teknologier:} Akka.NET, Blazor, Vue.js, C\#, Microsoft .NET Standard, ASP.NET, TeamCity, Octopus Deploy, Git, Powershell, Kiuwan.
...
\longformdescription{Utvikling}{C\#, Akka.Net, Episerver CMS, Episerver Commerce, ASP.Net,, Apptus eSales, inRiver PIM, IdentityServer, T-SQL, PL/SQL, JavaScript, JSON, NServiceBus, REST, WebAPI, XML, HTML, CSS, Powershell, \LaTeX.}

\longformdescription{Verktøy}{Jira, Confluence, TeamCity, Git, TFS, SubVersion, ReSharper, NewRelic, jMeter, BlazeMeter, NuGet, Kiuwan.}
