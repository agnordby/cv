...
\qquad Noen verktøy og teknologier Anders brukte i prosjektet: \textit{Akka.NET, TypeScript, React JS, Microsoft .NET Core 2.2, ASP.NET Core MVC, Keycloak, C\#, Microsoft SQL Server}.} 
