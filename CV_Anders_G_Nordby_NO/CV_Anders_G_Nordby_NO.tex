...
\textbf{Teknologier:} Azure DevOps, Azure DB, Azure WebServices, Akka.NET, TypeScript, React JS, C\#, Microsoft .NET Core 2.2, Microsoft .NET Standard, ASP.NET Core MVC, ASP.NET, Keycloak, TFS, Octopus Deploy, Git, Powershell.
} 
